...
$(document).ready(function () {
    ...
    $('.hapus-kolektif').click(function (e) {
        e.preventDefault();
        const url = $(this).attr('href');
        let dataId = [];
        let rows_selected = datatables.column(0).checkboxes.selected();
        ...
        Swal.fire({
            title: 'Anda yakin?',
            text: "Anda yakin ini menghapus secara kolektif?",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#1A237E',
            cancelButtonColor: '#B71C1C',
    ...
    $('.table').on('click', '.btn-copy', function (e) {
        e.preventDefault();
        let url = $(this).attr('href');
        let title = $(this).data('title');
        let duplikatedit = $(this).data('duplikatedit');

        Swal.fire({
            title: `${title}`,
            html: `<a href="${url}" class="btn btn-sm btn-dark me-3">Duplikat</a>
                    <a href="${duplikatedit}" class="btn btn-sm btn-warning text-dark">Duplikat & Edit</a>`,
            // icon: 'warning',
            showCancelButton: false,
            showConfirmButton: false,
