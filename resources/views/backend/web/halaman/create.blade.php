...
@section('konten')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form action="{{ route('halaman.store') }}" method="POST" enctype="multipart/form-data" id="my-form">
            @csrf
            <div class="row">
                <div class="col-md-8">
                    <div class="card mb-4">
                        <h5 class="card-header">Tambah halaman</h5>
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="deskripsi" id="deskripsi" class="form-control quilljs-textarea" cols="30" rows="10"></textarea>
                                </div>
                            </div>
