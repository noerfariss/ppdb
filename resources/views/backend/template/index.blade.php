        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row mb-4">
                    ...
                    <div class="col-sm-9 mt-2">
                        @permission('template-create')
                            <a href="{{ route('template.create') }}" class="btn btn-sm btn-primary float-end">Tambah</a>
                        @endpermission
                ...
                @permission('template-delete')
                    <a href="{{ route('template.delete') }}" class="btn btn-xs btn-outline-primary hapus-kolektif"><i
